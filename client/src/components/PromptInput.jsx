...
const PromptInput = ({onSubmit,loading=false,placeholder="Describe the website you ant to build...",
                ...
                transition'>
                    <textarea ref={textareaRef} value={value} onChange={(e)=>setValue(e.target.value)}
                        ...
                        <div className='flex items-center justify-between pb-3 px-3 gap-2'>
                            ...
                            hover:text-white hover:border-white/30 p-1.5 rounded-md cursor-pointer flex items-center
                            justify-center'>
